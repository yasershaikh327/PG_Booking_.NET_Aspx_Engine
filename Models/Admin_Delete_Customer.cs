...
{
    public class Admin_Delete_Customer
    {
        public string Message { get; set; }
        public void ADC(String DeleteCustomer)
        {
            SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["AshrayaConnectionString"].ConnectionString);
            SqlCommand Cmd = new SqlCommand("  Select Count(B.Booking_ID)  From Booking B,Registration_Table RT WHere (RT.ID=B.Customer_ID) AND (RT.Role='Customer')  AND (RT.ID='"+DeleteCustomer+"');", Con);
            Con.Open();
            ...
            else
            {
                ...
                SqlCommand FetchCustomerCMD = new SqlCommand("Select Email From Registration_Table Where ID ='" + DeleteCustomer + "';", Con);
                Con.Open();
  ...
  "</table>";
                ...
                SqlCommand DeleteCustomerCMD = new SqlCommand("Delete From Registration_Table Where ID ='"+DeleteCustomer+"';", Con);
                Con.Open();
