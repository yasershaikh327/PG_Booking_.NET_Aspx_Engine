  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"/>
    <script runat="server">
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SelectCPassword = PasswordCmd.ExecuteScalar().ToString();
...
<body>
  ...
  <div class="register" style="z-index:-1;">
    ...
    <form runat="server" id='updatecustomer' name='updatecustomer' style="overflow-y:scroll;">
            ...
            <div class="details ID">
                ...
                <div class="fields">
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" id='cpass_u' name='cpass_u' placeholder="Re-enter password" runat="server" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[!@#$%^&*?_-])(?=.*[^\da-zA-Z]).{8,15}$" title="Use 8 to 15 characters with a mix of letters, numbers & symbols" required="required" maxlength="15">
                    </div>
