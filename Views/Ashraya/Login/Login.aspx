...
<head>
  ...
  <title>Login</title>
  <link rel="stylesheet" href="../../../Contents/CSS3/Logins.css">
 ...
 <script runat="server">
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Page.ClientScript.RegisterStartupScript(this.GetType(), "CallMyFunction", "Login_Success();", true);
            }
        }
    </script>
    <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
    <script src="../../../Contents/Javascript/Login.js"></script>
</head>
<body>
  <div class="main">
  ...
  <div class="container"  style="left:19%;">
    ...
    <div class="forms">
        <div class="form-content">
          ...
          <form runat="server" id='logins' name='logins'>
            <div class="input-boxes">
              <div class="input-box">
                <i class="fas fa-envelope"></i>
                <input type="email" runat="server" name="Email_S" id="Email_S" placeholder="Enter your email" required="required">
              </div>
              <div class="input-box">
                <i class="fas fa-lock"></i>
                <input type="password" runat="server" name="Password_S" id="Password_S"  placeholder="Enter your password" required="required"  pattern="{8,15}" maxlength="15" title="Password Should be 8 to 15 Characters">
              </div>
              <div class="text"><a href='<%= Url.Action("ForgetPassword", "Ashraya") %>'>Forgot password?</a></div>
              <div class="button input-box">
                <input type="submit" value="Submit">
              </div>
              <div class="text sign-up-text">Don't have an account? <a href=<%= Url.Action("Verifications", "Ashraya") %>>Signup now</div>
            </div>
        </form>
      </div>
