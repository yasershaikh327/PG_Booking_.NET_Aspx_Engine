...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        System.Data.SqlClient.SqlCommand Owner = new System.Data.SqlClient.SqlCommand("Select Count(*) From PG P,Registration_Table R  Where (R.ID=P.Owner_ID) AND (R.Role='Owner') ;", Con);
        Con.Open();
        ...
        else if (!IsPostBack)
        {
            ...
            {
                System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("Select Name,Location,ZipCode,Img1,Img2,Img3,Date_of_PG_Added From PG;", con);
  ...
  <div class="wrapper" style="z-index:1">
   <nav>
    ...
    <table>
      ...
      <tbody>
        <tr>
          <td data-label="PG Name"><%#Eval("Name") %></td>
          <td data-label="Location"><%#Eval("Location") %></td>
          <td data-label="Zip Code"><%#Eval("ZipCode") %></td>
          ...
          <td data-label="PG Added Date"><%#Eval("Date_of_PG_Added") %></td>
          </tr>
      </tbody>
    </table>
  </div>
