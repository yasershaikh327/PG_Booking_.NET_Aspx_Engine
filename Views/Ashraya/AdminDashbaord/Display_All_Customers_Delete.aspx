...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        System.Data.SqlClient.SqlCommand Owner = new System.Data.SqlClient.SqlCommand("Select Count(*) From Registration_Table Where Role='Customer';", Con);
        Con.Open();
        ...
        else if (!IsPostBack)
        {
            ...
            {
                System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("Select ID,FirstName,LastName,Email,Address,Date From Registration_Table WHERE Role='Customer';", con);
            ...
            {
                Page.ClientScript.RegisterStartupScript(this.GetType(), "CallMyFunction", "NoDeleteCustomer();", true);
                return;
            }
...
<body>
  ...
  <div class="wrapper" style="z-index:1">
    <nav>
      ...
      <form runat="server" id='ADC' name='ADC'><!-- style="position: inherit;z-index: -1;margin-left: 4%;width: 91%;margin-top: 21%;">-->
        ...
        <tr>
          ...
          <td data-label="Date of Registration"><%#Eval("Date") %></td>
                   ...
                   <span class="action_btn">
                       <button type="submit" style=" font-size: large;background-color: #00bcd4;color: white;border: 3px solid white;border-radius: 9px;padding: 7px;"  value="<%#Eval("ID")%>" name='DeleteCustomer' id='DeleteCustomer'>Remove</button>
            </span>
            </td>
          </tr>
      </tbody>
