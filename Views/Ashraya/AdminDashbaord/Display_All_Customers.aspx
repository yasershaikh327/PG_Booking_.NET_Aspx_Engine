...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (!IsPostBack)
        {
            ...
            {
                System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("Select FirstName,LastName,Email,Address,Date From Registration_Table WHERE Role='Customer';", con);
